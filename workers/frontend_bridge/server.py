...
def get_nodes(include_demo: bool = False):
    ...
    if include_demo:
        demo_nodes = [
            ...
            NodeInfo(id="demo-draft-us-east-1", type="draft", hardware="NVIDIA A10G 24GB", model="Qwen/Qwen2.5-1.5B-Instruct", status="online", latency=8, price=0.05, gpu_memory="24 GB", location={"lat": 40.7128, "lng": -74.0060, "city": "New York", "country": "USA"}, earnings=0.0, uptime=99.9),
            ...
            NodeInfo(id="demo-draft-germany", type="draft", hardware="NVIDIA RTX 4080", model="Qwen/Qwen2.5-1.5B-Instruct", status="online", latency=16, price=0.04, gpu_memory="16 GB", location={"lat": 52.5200, "lng": 13.4050, "city": "Berlin", "country": "Germany"}, earnings=0.0, uptime=99.6),
            ...
            NodeInfo(id="demo-draft-tokyo", type="draft", hardware="NVIDIA RTX 4090", model="Qwen/Qwen2.5-1.5B-Instruct", status="online", latency=26, price=0.04, gpu_memory="24 GB", location={"lat": 35.6762, "lng": 139.6503, "city": "Tokyo", "country": "Japan"}, earnings=0.0, uptime=99.7),
            ...
            NodeInfo(id="demo-draft-sydney", type="draft", hardware="NVIDIA RTX 4080", model="Qwen/Qwen2.5-1.5B-Instruct", status="online", latency=33, price=0.04, gpu_memory="16 GB", location={"lat": -33.8688, "lng": 151.2093, "city": "Sydney", "country": "Australia"}, earnings=0.0, uptime=99.0),
