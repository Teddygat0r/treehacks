...
export TARGET_MODEL="${TARGET_MODEL:-Qwen/Qwen2.5-3B-Instruct}"
export DRAFT_MODEL_ID="${DRAFT_MODEL_ID:-$DRAFT_MODEL}"
export TARGET_MODEL_ID="${TARGET_MODEL_ID:-$TARGET_MODEL}"
